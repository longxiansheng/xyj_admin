...
<script lang="ts">
  ...
  import { GetServicePerLevelDictionaryByPaged, DelServicePerLevelDictionaryById } from '/@/api/dictionary/servicePerLevelDictionary/servicePerLevelDictionary';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload, updateTableDataRecord }] = useTable({
        ...
        api: GetServicePerLevelDictionaryByPaged,
        rowKey: 'id',
      ...
      function handleDelete(record: Recordable) {
        DelServicePerLevelDictionaryById({id :record.id}).then(()=>{
          reload();
        })
      }
